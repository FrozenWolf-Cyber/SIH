...
#     print(json.loads(x.text).keys(), len(json.loads(x.text)['embed1']))
    ...
    x = requests.post(url, data= {'user_id' : user_id, "old_check_in":"06.03.2022@10:53:56", "old_check_out":"06.03.2022@10:53:56", "new_check_in":"26.9.2022@12:47:19", "new_check_out":"18.10.2022@17:53:56"})
    print(x.text)
